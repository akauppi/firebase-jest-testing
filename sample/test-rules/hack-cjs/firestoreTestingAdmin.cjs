// MOVE to 'firebaseTesting.js' in 'src', when 'globalSetup' can take ES modules...
/*
...
const firebase= require('@firebase/testing');   // CommonJS: no need for 'await' since 'require' is just code
