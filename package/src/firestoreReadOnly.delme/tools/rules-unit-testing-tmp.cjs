/*
* Based on -> https://github.com/firebase/firebase-js-sdk/blob/master/packages/rules-unit-testing/src/api/index.ts
*
* '@firebase/rules-unit-testing' depends on 'firebase' (8.x), for example. Being able to build without it *radically*
* reduces our build dependencies.
*/
